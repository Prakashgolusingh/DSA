...
<div class="elfjS" data-track-load="description_content"><p>A string is a <strong>valid parentheses string</strong> (denoted <strong>VPS</strong>) if it meets one of the following:</p>
